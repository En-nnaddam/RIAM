...
try {
    ...
    $demandes = Labilisation::displayAllforAdmin();
...
<head>
    ...
    <title>Consultation des demandes de labilisation</title>
...
<body>
    ...
    <?php include('./controllers/consulte_demandes_labilisation.controller.php') ?>
</body>
